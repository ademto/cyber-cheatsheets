        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              By accessing and using Cyber Cheatsheets, you accept and agree to be bound by the terms 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Permission is granted to temporarily download one copy of the materials on Cyber Cheatsheets 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The materials on Cyber Cheatsheets are provided on an 'as is' basis. We make no warranties, 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              In no event shall Cyber Cheatsheets or its suppliers be liable for any damages (including, 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The materials appearing on Cyber Cheatsheets could include technical, typographical, or 
              photographic errors. We do not warrant that any of the materials on our website are accurate, 
              complete, or current. We may make changes to the materials contained on our website at any 
              time without notice.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Cyber Cheatsheets has not reviewed all of the sites linked to its website and is not 
              responsible for the contents of any such linked site. The inclusion of any link does not 
              imply endorsement by Cyber Cheatsheets of the site.
            </p>
          </section>
